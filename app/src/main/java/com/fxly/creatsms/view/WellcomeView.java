...
public class WellcomeView  extends View {
    ...
    RectF oval  = null;
    private int m = -90;
    public WellcomeView(Context context) {
        super(context);
        this.mContext = context;
        init();
    }

    public WellcomeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        init();
    }

    public WellcomeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(){
        ...
        solidRound.setStyle(Paint.Style.FILL);
